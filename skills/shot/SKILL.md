---
name: shot
description: "PUA Shot — version concentrée originale v2 (449 lignes injection complète), version mono-fichier avant découpage, saveur maximale. Zéro dépendance, zéro référence, injection unique dans le contexte. Idéal pour injection dans les sub-agents, quand on veut l'effet PUA le plus fort, ou sans chargement progressif. Triggers on: '/pua:shot', '/pua shot', 'shot mode', 'PUA concentré', 'injection complète'. Parfait aussi pour injecter dans les sub-agents via Read tool car autonome."
license: MIT
---
